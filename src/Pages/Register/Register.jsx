    ...
    <div className="bg-[url(https://i.ibb.co/smFhVQh/ning-31-min.jpg)] bg-cover">
      <div className="bg-transparent dark:bg-gray-900">
        <div className="max-w-7xl mx-auto p-10">
          <div className="bg-white dark:bg-gray-800 rounded shadow p-10 flex items-center">
            ...
            <div className=" w-full md:w-1/2 md:pl-10 md:border-l border-gray-300">
              ...
              <form onSubmit={handleRegister} className="mt-8">
                <input
                  className="px-5 py-2 outline-none border border-gray-200 text-neutral-800  bg-slate-200 dark:bg-gray-600 dark:border-gray-500 dark:placeholder:text-gray-400 dark:text-gray-200 rounded-md w-full mb-4"
                  type="text"
                  name="name"
                ...
                <div className="relative">
                  <input
                    className="px-5 py-2 outline-none border border-gray-200 text-neutral-800  bg-slate-200 dark:bg-gray-600 dark:border-gray-500 dark:placeholder:text-gray-400 dark:text-gray-200 rounded-md w-full mb-2"
              ...
              <p className="text-center -mb-3.5">
                <span className="bg-white dark:bg-gray-800 z-10 inline-block px-2">
                  Or login
                </span>
              </p>
